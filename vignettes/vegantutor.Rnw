...
<<a>>=
biplot(vare.pca, correlation = TRUE)
@
\marginpar{
...
For this graph we specified \texttt{correlation = TRUE}. The results are
...
\texttt{correlation} argument means that species scores are divided by the species
